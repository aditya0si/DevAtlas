...
- Implementing React Server Components and Server Actions
- Configuring route handlers, middleware, and API routes
- Adding streaming SSR and partial prerendering
- Writing `generateMetadata` for SEO optimization
- Scaffolding `loading.tsx` and `error.tsx` boundaries
- Deploying to Vercel or self-hosting
- Optimizing images, fonts, and bundles
