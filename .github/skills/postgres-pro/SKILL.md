...
### EXPLAIN ANALYZE — Identify Slow Query
...
Look for: `Seq Scan` on large tables, high `Buffers` hit count, nested loops on large sets.

### Index Creation — Verify Before Deploy
